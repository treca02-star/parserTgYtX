        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "Альтсезон, Психология трейдинга, Результаты торговли, Потеря депозита, "
                    "Разбор сделки, Алготрейдинг, Геополитика, Технологии, Автомобили, "
                    "Путешествия, Наблюдение, Юмор, Личный блог, Реклама или Другое. "
                    "Личный короткий рассказ или впечатление автора, в том числе о машине, "
                    "поездке или бытовой ситуации, классифицируй как Жизненная история. "
                    "Автомобили используй для полноценного обзора или новости об автомобиле. "
                    "Если материал о конкретной сделке или активе, указывай его тикер в "
                    "категории. Другое используй только когда в тексте действительно нет "
                    "понятной темы или содержательной информации. "
                    "Отдельно определи "
